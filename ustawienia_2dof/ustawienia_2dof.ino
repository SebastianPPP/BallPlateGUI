...
void updateServos() {
    ...
    int ms1 = BASE_PULSE + (int)(u1_out * US_PER_DEGREE);
    int ms2 = BASE_PULSE + (int)(u2_out * US_PER_DEGREE);
    int ms3 = BASE_PULSE + (int)(u3_out * US_PER_DEGREE);
